/**
 * Records marketing/reel-sales-followers-portrait.html (?export=video).
 * Serves ../public for slothlogo + reel-sales-assets for AI still.
 *
 * Usage: npm run export-reel-sales-followers-video
 */
...
const htmlFile = "reel-sales-followers-portrait.html";
...
const webmPath = path.join(outDir, `reel-sales-followers-${stamp}.webm`);
