...
// Run from website/: node scripts/import-ash-mockups.mjs docs/<manifest>.json
const manifestPath = process.argv[2];
if (!manifestPath) throw new Error('Pass a mockup manifest JSON path.');
const manifest = JSON.parse(await fs.readFile(manifestPath, 'utf8'));
const originals = 'design/ashfall-outpost';
const publicDir = 'public/images/game-ui/ashfall-outpost';
