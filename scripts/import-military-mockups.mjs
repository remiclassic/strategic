...
// Run from website/: node scripts/import-military-mockups.mjs docs/<manifest>.json
const manifestPath = process.argv[2];
if (!manifestPath) throw new Error('Pass a mockup manifest JSON path.');
const manifest = JSON.parse(await fs.readFile(manifestPath, 'utf8'));
const originals = 'design/fieldline';
const publicDir = 'public/images/game-ui/fieldline';
